...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Adiciona um cartão a um jogo</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Mostra a lista de cartões associados a um jogo</td>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Atualiza o time do jogador. O endpoint verifica a quantidade de jogares por time e libera ou não o update</td>
                    </tr>
            ...
            <h2>Testes</h2>
            <p>
                Foram criados testes para garantir a consistência dos endpoints. Para os testes funcionarem é necessário criar um banco de dados especifico para eles e adicionar as configurações em um arquivo <code>.env.testing</code><br/>
                <br/>
